...
namespace UprojectShortcuts.Commands
{
    ...
    internal sealed class LaunchEditorCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LaunchEditorCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="Package">Owner package, not null.</param>
        /// <param name="CommandService">Command service to add command to, not null.</param>
        private LaunchEditorCommand(AsyncPackage Package, OleMenuCommandService CommandService)
        {
        ...
        private void Execute(object Sender, EventArgs Args)
        {
            ...
            FunctionLibrary.InvokeUprojectCommand(
                UprojectCommandType.LaunchEditor,
                FilePath
            );
        }
    }
